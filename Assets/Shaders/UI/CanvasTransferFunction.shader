...
/// </summary>
Shader "Graphics Tools/Canvas Transfer Function"
{
    Properties
    {
        // Main maps.
        ...
        [PerRendererData] _colorMapParams("Color Map Parameters", Vector) = (5,0,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include_with_pragmas "ColorMapButtonInclude.hlsl"
